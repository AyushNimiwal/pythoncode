...
class demos(MDApp):
    def build(self):
        ...
        return screen
demos().run()
# userID=MDTextField(text="Enter ID",pos_hint={"center_x":0.5,"center_y":0.6},size_hint_x=None,width=300)
# userPassword = MDTextField(text="Password",pos_hint={"center_x":0.5,"center_y":0.5},size_hint_x=None,width=300)
# label=MDLabel(text="Enter your Employee ID",halign="center",pos_hint={"center_x":0.5,"center_y":0.7},theme_text_color="Primary",font_style="H6")
# screen.add_widget(userID)
# screen.add_widget(userPassword)
